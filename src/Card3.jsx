...
export const Card3 = () => {
  ...
  return (
    <div className="max-w-xl mx-auto mt-16 bg-white rounded-xl shadow-lg overflow-hidden border border-emerald-300 p-8">
      ...
      />
      <h2 className="text-3xl font-bold text-emerald-700 mt-6 mb-4">The Evolution of Computers</h2>
      ...
      <h3 className="text-xl font-semibold text-emerald-600 mb-2">Major Milestones in Computer Evolution</h3>
      ...
      <h3 className="text-xl font-semibold text-emerald-600 mb-2">Impact on Society</h3>
      <ul className="list-disc list-inside text-gray-700 mb-4">
